...
class MainWindow(QMainWindow):
    ...
    def __init__(self, runtime: ApplicationRuntime) -> None:
        ...
        self.setWindowTitle("Windows PC Manager Agent")
        self.setAccessibleName("Windows PC Manager Agent 主窗口")
        self.resize(1_080, 720)
        self._tabs = QTabWidget()
        self._tabs.setAccessibleName("主要功能页面")
    ...
    def _build_chat_tab(self) -> None:
        ...
        self._conversation.setAccessibleName("对话记录")
    ...
    def _build_scan_tab(self) -> None:
        ...
        self._root_input.setAccessibleName("授权扫描目录")
        self._root_input.setPlaceholderText("选择一个明确授权的扫描目录")
        browse_button = QPushButton("选择目录")
        plan_button = QPushButton("生成安全计划")
        browse_button.setAccessibleName("选择授权扫描目录")
        plan_button.setAccessibleName("生成只读扫描安全计划")
        ...
        self._risk_label.setAccessibleName("扫描计划风险")
        self._risk_label.setStyleSheet("font-weight: 600;")
        self._plan_view = QTextBrowser()
        self._plan_view.setAccessibleName("结构化扫描计划")
        ...
        self._confirm_button.setAccessibleName("确认只读扫描计划")
        self._reject_button.setAccessibleName("拒绝只读扫描计划")
        self._scan_button.setAccessibleName("开始只读扫描")
        self._cancel_button.setAccessibleName("取消只读扫描")
        ...
        self._progress.setAccessibleName("只读扫描进度")
        self._progress.setRange(0, 1)
        self._progress.setValue(0)
        self._results = QTableWidget(0, 6)
        self._results.setAccessibleName("只读扫描结果")
