...
class SafeModeWindow(QMainWindow):
    ...
    def __init__(self, runtime: ApplicationRuntime) -> None:
        ...
        self.setAccessibleName("Windows PC Manager Agent 安全模式窗口")
        self.resize(820, 560)
        self._tabs = QTabWidget()
        self._tabs.setAccessibleName("安全模式页面")
    ...
    def _build_audit_tab(self) -> None:
        ...
        refresh.setAccessibleName("刷新安全模式审计元数据")
        refresh.clicked.connect(self._refresh_audit)
        self._audit = QTableWidget(0, 4)
        self._audit.setAccessibleName("安全模式审计记录")
    ...
    def _build_settings_tab(self) -> None:
        ...
        diagnostic_bundle.setAccessibleName("预览并导出已脱敏诊断包")
